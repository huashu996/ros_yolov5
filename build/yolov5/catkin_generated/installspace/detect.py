...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default=ROOT / './runs/train/exp2/weights/best.pt', help='model path(s)')
...
if __name__ == "__main__":
    opt = parse_opt()
    device = ''
    weights = '/home/cxl/ros_yolov5/src/yolov5/runs/train/exp2/weights/best.pt'
    dnn=False
